...
function App() {
  ...
  sx={{
    ...
    strokeDashoffset: '2670.019775390625px',
    strokeDasharray: '2670.019775390625px',
    fill: 'transparent',
...
/>
      ...
      >
        Explore current weather data and 6-day forecast of more than 2
        cities!
      </Typography>
      {/* <Box
  display="flex"
    ...
    >
      <Grid container columnSpacing={2}>
        <Grid item xs={12}>
          ...
          <Search onSearchChange={comparisonSearchChangeHandler} />
        </Grid>
        {appContent}
      </Grid>
    </Container>
